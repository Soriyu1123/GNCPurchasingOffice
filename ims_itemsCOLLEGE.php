<?php
    ...
    $run = mysqli_query($conn, "select * from `items_college`");
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="card" style="width: 100%; height: auto">
                <div class="col-lg">
                    <div class="card-body">
                        ...
                        <!-- Table -->
                        <h1 class="uppercase">College Department</h1><br>
                        <table class="additems">
                            <form action="ims_additemsCOLLEGE.php" method="POST" enctype="multipart/form-data">
                                <tr>
                                ...
                                <tr>
                                    <td><label for="course_code">Program Course:</label></td>
                                    <td>
                        ...
                        function confirmDelete(itemId) {
                            if (confirm("Are you sure you want to delete this item?")) {
                                window.location.href = 'ims_deleteCOLLEGE.php?id=' + itemId;
                            }
                        }
                        </script>
                                            ...
                                            while ($result = mysqli_fetch_assoc($run)) {
                                                ...
                                                echo "
                                                    <tr class='data'>
                                                        ...
                                                        <td>" . $result['price'] . "</td>
                                                        <td> 
                                                            <a href='ims_editCOLLEGE.php?id=" . $result['id'] . "' title='Edit' class='btn btn-primary m-auto mb-2'><i class='fa-regular fa-pen-to-square' style='color: #ffffff;'></i></a>

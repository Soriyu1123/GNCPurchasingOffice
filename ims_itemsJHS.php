            ...
            <div class="card" style="width: 100%; height: auto">
                <div class="col-lg">
                    <div class="card-body">
                        ...
                        <h1 class="uppercase">Junior High School Department</h1><br>
                            <table class="additems">
                            <form action="ims_addItemsJHS.php" method="POST" enctype="multipart/form-data">
                        ...
                        function confirmDelete(itemId) {
                            if (confirm("Are you sure you want to delete this item?")) {
                                window.location.href = 'ims_deleteJHS.php?id=' + itemId;
                            }
                        }
                        </script>
                                            ...
                                            while ($result = mysqli_fetch_assoc($run)) {
                                                ...
                                                echo "
                                                    <tr class='data'>
                                                        ...
                                                        <td>" . $result['price'] . "</td>
                                                        <td> 
                                                            <a href='ims_editJHS.php?id=" . $result['id'] . "' title='Edit' class='btn btn-primary m-auto mb-2'><i class='fa-regular fa-pen-to-square' style='color: #ffffff;'></i></a>

            ...
            <div class="card" style="width: 100%; height: auto">
                <div class="col-lg">
                    <div class="card-body">
                        ...
                        <!-- Table -->
                        <h1 class="uppercase">Montessori Department</h1><br>
                        <table class="additems">
                            <form action="ims_additemsMONTE.php" method="POST" enctype="multipart/form-data">
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="grade_level">
                                            <option value="All MONTE Levels">All Montessori Levels</option>
                                            <option value="7 (MONTE)">7 (MONTE)</option>
                                            <option value="8 (MONTE)">8 (MONTE)</option>
                                            <option value="9 (MONTE)">9 (MONTE)</option>
                                            <option value="10 (MONTE)">10 (MONTE)</option>
                                            <option value="11 (MONTE)">11 (MONTE)</option>
                                            <option value="12 (MONTE)">12 (MONTE)</option>
                                        </select>
                                    </td>
                                </tr>
                        ...
                        function confirmDelete(itemId) {
                            if (confirm("Are you sure you want to delete this item?")) {
                                window.location.href = 'ims_deleteMONTE.php?id=' + itemId;
                            }
                        }
                        </script>
                                            ...
                                            while ($result = mysqli_fetch_assoc($run)) {
                                                ...
                                                echo "
                                                    <tr class='data'>
                                                        ...
                                                        <td>" . $result['price'] . "</td>
                                                        <td> 
                                                            <a href='ims_editMONTE.php?id=" . $result['id'] . "' title='Edit' class='btn btn-primary m-auto mb-2'><i class='fa-regular fa-pen-to-square' style='color: #ffffff;'></i></a>

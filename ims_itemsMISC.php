<?php
    ...
    $run = mysqli_query($conn, "select * from `items_misc`");
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="card" style="width: 100%; height: auto">
                <div class="col-lg">
                    <div class="card-body">
                        ...
                        <!-- Table -->
                        <h1 class="uppercase">Miscellaneous Items</h1><br>
                        <table class="additems">
                            <form action="ims_additemsMISC.php" method="POST" enctype="multipart/form-data">
                                <tr>
                        ...
                        function confirmDelete(itemId) {
                            if (confirm("Are you sure you want to delete this item?")) {
                                window.location.href = 'ims_deleteMISC.php?id=' + itemId;
                            }
                        }
                        </script>
                                            ...
                                            while ($result = mysqli_fetch_assoc($run)) {
                                                ...
                                                echo "
                                                    <tr class='data'>
                                                        ...
                                                        <td>" . $result['price'] . "</td>
                                                        <td> 
                                                            <a href='ims_editMISC.php?id=" . $result['id'] . "' title='Edit' class='btn btn-primary m-auto mb-2'><i class='fa-regular fa-pen-to-square' style='color: #ffffff;'></i></a>

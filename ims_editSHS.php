<?php
    ...
    if (isset($_GET['id'])) {
        ...
        $query = "SELECT * FROM `items_shs` WHERE `id`='$id'";
                ...
                <div class="col-lg">
                    <div class="card-body">
                        ...
                        <table class="additems">
                            <form action="ims_updateSHS.php" method="POST" enctype="multipart/form-data">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="grade_level">
                                            <option value="All JHS Levels">All SHS Levels</option>

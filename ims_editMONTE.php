<?php
    ...
    if (isset($_GET['id'])) {
        ...
        $query = "SELECT * FROM `items_monte` WHERE `id`='$id'";
                ...
                <div class="col-lg">
                    <div class="card-body">
                        ...
                        <table class="additems">
                            <form action="ims_updateMONTE.php" method="POST" enctype="multipart/form-data">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="grade_level">
                                            <option value="All Monte Levels">All Monte Levels</option>

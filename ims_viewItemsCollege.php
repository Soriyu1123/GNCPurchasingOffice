            ...
            <div class="col-lg">
                <div class="card-body">
                    ...
                    <div id="printable-items">
                        <br>
                        <h1 class="display-4">College</h1><br>
                        <br>
                        ...
                        <div class="container mb-3"><p>Filter by:</p>
                            ...
                            <button class="btn btn-dark filter-button" data-category="Course Patch">Course Patches</button>
                                                ...
                                                <a href="#" class="card-link" data-toggle="modal" data-target="#cardModal' . $i . '">
                                                    ...
                                                    <div class="card-body text-dark">
                                                        <h5 class="card-title">' . $result['name'] . '</h5>
                                                         <p>Course Code: ' . $result['course_code'] . '</p>
